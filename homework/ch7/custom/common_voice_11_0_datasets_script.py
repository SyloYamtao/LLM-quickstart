...
# _BASE_URL = "/root/dataDisk/hf/hub/datasets/common_voice_11_0/"
_BASE_URL =  "https://hf-mirror.com/datasets/mozilla-foundation/common_voice_11_0/resolve/main/"
...
class CommonVoice(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        print(f"Current language configuration: {self.config.name}")  # 打印当前语言配置
        ...
        # 打印所有的 audio_urls
        print("Audio URLs for all splits:")
        for split, urls in audio_urls.items():
            print(f"{split}:")
            for url in urls:
              print(url)
        ...
        print(f"Metadata URLs for {lang}: {meta_urls}")  # 打印元数据 URL
